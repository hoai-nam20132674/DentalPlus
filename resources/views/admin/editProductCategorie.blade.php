                        ...
                        <div class="form-group ">
                            <div id="edit-slug-box"  class="" >
                                ...
                                <span class="default-slug">http://dentalplusvn.com/<span id="editable-post-name">
                                    <input type="text" name="url" id="new-post-slug" class="form-control is-valid" value="{{$cate->url}}" autocomplete="off"></span></span></span>
     ...
     <div class="widget-body">
        ...
        <div class="seo-edit-section">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="seo_title" value="{{$cate->title}}" placeholder="Tiêu đề trang" data-counter="120" name="title" type="text" required >
            </div>
            <div class="form-group">
                <label for="seo_description" class="control-label">Từ khóa</label>
                <textarea class="form-control" rows="3" id="seo_keyword" placeholder="từ khóa" data-counter="155" name="seo_keyword" required cols="50">{{$cate->seo_keyword}}</textarea>
            </div>
            <div class="form-group">
                <label for="seo_description" class="control-label">Mô tả trang</label>
                <textarea class="form-control" rows="3" id="seo_description" placeholder="Mô tả trang" data-counter="155" required name="seo_description" cols="50">{{$cate->seo_description}}</textarea>
            </div>
        </div>
