...
@section('css')
    ...
    <link media="all" type="text/css" rel="stylesheet" href="http://hasa.botble.com/vendor/core/plugins/simple-slider/css/simple-slider-admin.css">
...
@section('js')
    ...
    <script src="http://hasa.botble.com/vendor/core/plugins/simple-slider/js/simple-slider-admin.js"></script>
