...
@section('js')
    ...
    <script src="http://hasa.botble.com/vendor/core/libraries/jquery.blockui.min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/libraries/sortable/sortable.min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/libraries/jQuery.equalHeights/jquery.equalheights.min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/libraries/counterup/jquery.counterup.min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/libraries/raphael-min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/libraries/morris/morris.min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/js/dashboard.js"></script>
    <script src="http://hasa.botble.com/vendor/core/plugins/analytics/libraries/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="http://hasa.botble.com/vendor/core/plugins/analytics/libraries/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="http://hasa.botble.com/vendor/core/plugins/analytics/js/analytics.js"></script>
    <script src="http://hasa.botble.com/vendor/core/plugins/blog/js/blog.js"></script>
    <script src="http://hasa.botble.com/vendor/core/plugins/audit-log/js/audit-log.js"></script>
    <script src="http://hasa.botble.com/vendor/core/plugins/ecommerce/js/report.js"></script>
@endsection