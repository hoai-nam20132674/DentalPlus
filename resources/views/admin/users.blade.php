    ...
    <div class="dropdown-content">
            ...
            <div class="portlet-body">
                <div class="table-responsive  table-has-actions   table-has-filter ">
                                            <div id="table-users_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;"><div id="table-users_filter" class="dataTables_filter"><label><input type="search" class="form-control form-control-sm" placeholder="Search..." aria-controls="table-users"></label></div><div class="dt-buttons btn-group"> <button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-users"><span><span data-action="create" data-href="http://hasa.botble.com/admin/system/users/create"><i class="fa fa-plus"></i> Tạo mới</span></span></button> <button class="btn btn-secondary buttons-reload" tabindex="0" aria-controls="table-users"><span><i class="fas fa-sync"></i> Tải lại</span></button> </div><div id="table-users_processing" class="dataTables_processing card" style="display: none;"></div><table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-users" role="grid" aria-describedby="table-users_info" style="width: 1582px;"><thead><tr role="row"><th width="10px" class="text-left no-sort sorting_disabled" title="<input class=&quot;table-check-all&quot; data-set=&quot;.dataTable .checkboxes&quot; type=&quot;checkbox&quot;>" rowspan="1" colspan="1" aria-label="" style="width: 37px;"><input class="table-check-all" data-set=".dataTable .checkboxes" type="checkbox"></th><th title="Tên đăng nhập" class="text-left column-key-username sorting_desc" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-sort="descending" aria-label="Tên đăng nhậporderby asc" style="width: 181px;">Tên đăng nhập</th><th title="Email" class="text-left column-key-email sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Emailorderby asc" style="width: 271px;">Email</th><th title="Phân quyền" class="column-key-role_name sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Phân quyềnorderby asc" style="width: 191px;">Phân quyền</th><th title="Ngày tạo" width="100px" class="column-key-created_at sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Ngày tạoorderby asc" style="width: 100px;">Ngày tạo</th><th title="Trạng thái" width="100px" class="column-key-status sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Trạng tháiorderby asc" style="width: 100px;">Trạng thái</th><th title="Is super?" width="100px" class="column-key-super_user sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Is super?orderby asc" style="width: 100px;">Is super?</th><th title="Tác vụ" width="350px" class="text-right sorting_disabled" rowspan="1" colspan="1" aria-label="Tác vụ" style="width: 350px;">Tác vụ</th></tr></thead><tbody><tr role="row" class="odd"><td class=" text-left no-sort"><div class="text-left">
    <div class="checkbox checkbox-primary table-checkbox">
        <input type="checkbox" class="checkboxes" name="id[]" value="2">
    </div>
</div></td><td class="text-left column-key-username sorting_1"><a href="http://hasa.botble.com/admin/system/users/profile/2">namnguyen</a></td><td class=" text-left column-key-email">namnguyen@gmail.com</td><td class="  column-key-role_name"><a data-type="select" data-source="http://hasa.botble.com/admin/system/roles/json" data-pk="2" data-url="http://hasa.botble.com/admin/system/roles/assign" data-value="0" data-title="Assigned Role" class="editable editable-click" href="#">
    No role assigned
</a>
</td><td class="  column-key-created_at">2020-07-09</td><td class="  column-key-status"><span class="label-info status-label">Activated</span></td><td class="  column-key-super_user">No</td><td class=" text-right"><a href="http://hasa.botble.com/admin/system/users/make-super/2" class="btn btn-info">Make super</a><a href="http://hasa.botble.com/admin/system/users/profile/2" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="View user's profile"><i class="fa fa-eye"></i></a>

    <a href="#" class="btn btn-icon btn-danger deleteDialog" data-toggle="tooltip" data-section="http://hasa.botble.com/admin/system/users/2" role="button" data-original-title="Xóa bản ghi">
        <i class="fa fa-trash"></i>
    </a>
</td></tr><tr role="row" class="even"><td class=" text-left no-sort"><div class="text-left">
    <div class="checkbox checkbox-primary table-checkbox">
        <input type="checkbox" class="checkboxes" name="id[]" value="1">
    </div>
</div></td><td class="text-left column-key-username sorting_1"><a href="http://hasa.botble.com/admin/system/users/profile/1">botble</a></td><td class=" text-left column-key-email">contact@botble.com</td><td class="  column-key-role_name"><a data-type="select" data-source="http://hasa.botble.com/admin/system/roles/json" data-pk="1" data-url="http://hasa.botble.com/admin/system/roles/assign" data-value="0" data-title="Assigned Role" class="editable editable-click" href="#">
    No role assigned
</a>
</td><td class="  column-key-created_at">2020-06-12</td><td class="  column-key-status"><span class="label-info status-label">Activated</span></td><td class="  column-key-super_user">Yes</td><td class=" text-right"><a href="http://hasa.botble.com/admin/system/users/remove-super/1" class="btn btn-danger">Remove super</a><a href="http://hasa.botble.com/admin/system/users/profile/1" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="View user's profile"><i class="fa fa-eye"></i></a>

    <a href="#" class="btn btn-icon btn-danger deleteDialog" data-toggle="tooltip" data-section="http://hasa.botble.com/admin/system/users/1" role="button" data-original-title="Xóa bản ghi">
        <i class="fa fa-trash"></i>
    </a>
</td></tr></tbody></table><div class="datatables__info_wrap"><div class="dataTables_paginate paging_simple_numbers" id="table-users_paginate" style="display: none;"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="table-users_previous"><a href="#" aria-controls="table-users" aria-label="&amp;laquo; Trước" data-dt-idx="0" tabindex="0" class="page-link">« Trước</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="table-users" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="table-users_next"><a href="#" aria-controls="table-users" aria-label="Sau &amp;raquo;" data-dt-idx="2" tabindex="0" class="page-link">Sau »</a></li></ul></div><div class="dataTables_length" id="table-users_length" style="display: none;"><label><span class="dt-length-style"><select name="table-users_length" aria-controls="table-users" class="form-control form-control-sm"><option value="-1">Tất cả</option><option value="10">10</option><option value="30">30</option><option value="50">50</option></select></span></label></div><div class="dataTables_info" id="table-users_info" role="status" aria-live="polite"><span class="dt-length-records">
    <i class="fa fa-globe"></i> <span class="d-none d-sm-inline">Hiển thị từ</span> 1 đến 2 trong tổng số <span class="badge badge-secondary bold badge-dt">2</span> <span class="hidden-xs">bản ghi</span>
