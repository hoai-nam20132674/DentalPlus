            ...
            <ul class="nav navbar-nav float-right">
                ...
                <li class="language dropdown">
                    <a href="javascript:;" class="dropdown-toggle dropdown-header-name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="http://hasa.botble.com/vendor/core/images/flags/vn.svg" title="Tiếng Việt" width="16" alt="Tiếng Việt">
                        <span class="d-none d-sm-inline">Tiếng Việt</span>
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
                        <li>
                            <a href="http://hasa.botble.com/settings-language/en">
                                <img src="http://hasa.botble.com/vendor/core/images/flags/us.svg" title="English" width="16" alt="English">
                                <span>English</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="http://hasa.botble.com/settings-language/vi">
                                <img src="http://hasa.botble.com/vendor/core/images/flags/vn.svg" title="Tiếng Việt" width="16" alt="Tiếng Việt">
